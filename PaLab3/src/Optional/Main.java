...
public class Main {
    public static void main(String args[]) {
        ...
        List<Location> visitingOrder = Arrays.asList(location3);
        TravelPlan iasiTravelPlan = new TravelPlan(city1,visitingOrder);
        iasiTravelPlan.shortestPathByPreferences(location1,location6);
